...
{
    public class WormMinion : ModProjectile
    {
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, float distanceToIdlePosition, Vector2 vectorToIdlePosition)
        {
            ...
            if (foundTarget)
            {
                ...
                if (distanceFromTarget > 60f)
                {
                    ...
                    {
                        Projectile.velocity.Y -= Math.Min(3.2f - 0.03f * direction.Y + 0.0002f * direction.Y * direction.Y, 18f);
                        isInAir = true;
                        // Main.NewText("Attempting to jump while in pursuit", (byte)255, (byte)255, (byte)255);
                    }
        ...
        private void Visuals()
        {
            ...
            else
            {
                ...
                // set facing direction of velocity
                Projectile.spriteDirection = 1;
