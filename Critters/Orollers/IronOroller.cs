...
{
	public class IronOroller : CopperOroller
	{	
		...
		public override void SetDefaults() {
            NPC.catchItem = ModContent.ItemType<IronOrollerItem>();
            base.SetDefaults();
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.AddTags(BestiaryDatabaseNPCsPopulator.CommonTags.SpawnConditions.Biomes.Caverns,
                ...
                new FlavorTextBestiaryInfoElement("Orollers tend to live where their favorite ores are, but rarely you'll find them lost. These have an affinity for iron."),
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo) {
            ...
            if (Critters.Orollers.OreSaver.ironTier == TileID.Lead)
            {
                spawnModifier = 0.1f;
            }
            else if ((Critters.Orollers.OreSaver.ironTier == TileID.Iron))
            {
                spawnModifier = 0.9f;
            }
		...
		public override void OnCaughtBy(Player player, Item item, bool failed) {
            if (hasOrb)
            {
                Item.NewItem(null, this.Entity.Center, 0, 0, ItemID.IronOre, (int)Math.Ceiling((1 + item.pick * 0.01) * new Random().Next(25, 35)), false, 0, false, false);
            }
        }
    ...
    public class IronOrollerItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.makeNPC = ModContent.NPCType<IronOroller>();
            Item.useStyle = 1;
            Item.autoReuse = true;
            Item.useTurn = true;
            ...
            Item.SetNameOverride("Iron Oroller");
            Item.rare = ItemRarityID.White;
        }
    }

    public class IronOrexcavator : ModItem
    {
        public override void SetDefaults()
        {
            Item.damage = 15;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<IronOrollerItem>(), 1);
